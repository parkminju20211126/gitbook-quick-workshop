...
> **주의:** 이메일 Connection이 필요합니다. (STEP 5에서 연결)
...
Quick 안에서 쓰는 앱을 만듭니다. STEP 4의 HTML 대시보드와 달리 Quick 내부에서 실행됩니다.
...
> **다음:** [STEP 7. 최종 체크 →](step-7-checklist.md)
